...
function Fac(){
  ...
  [
    ...
    },
    {
      ...
      "FacultyWorkingSince": "Jul-2009",
      "FacultyImage": "https://darshan.ac.in/U01/Faculty-Photo/12---28-04-2023-02-06-51.jpg"
    },
    {
      "id": "6",
  ...
  const [facultyarr , setFacultyarr] = useState(arr);

  function deletedata(FacultyName){
    setFacultyarr(facultyarr.filter((e)=>{
      return e.FacultyName!=FacultyName;
    }))
  }

 const Printdata = facultyarr.map((faculty) => {
  ...
  return (
    <>
      ...
      <Faculties 
        ...
        FacultyEducationQualification={faculty.FacultyEducationQualification}
        FacultyExperience={faculty.FacultyExperience}
        FacultyWorkingSince={faculty.FacultyWorkingSince}
        FacultyImage={faculty.FacultyImage}
        deletedata = {()=>{
          deletedata(faculty.FacultyName)
        }}
       />
